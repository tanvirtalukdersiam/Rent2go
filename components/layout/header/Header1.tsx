              ...
              <div className="header-nav">
                <nav className="nav-main-menu">
                  <ul className="main-menu">
                    <li className="">
                      <Link className="color-white" href="/index-2">
                        Home
                      </Link>
                    ...
                    <li className=" ">
                      <Link className="color-white" href="/cars-list-1">
                        Vehicles
                      </Link>
                    ...
                    <li className="">
                      <Link className="color-white" href="/dealer-listing">
                        Dealers
                      </Link>
                    </li>
                    <li className="">
                      <Link className="color-white" href="/shop-list">
                        Shop
                      </Link>
                      {/* <ul className="sub-menu">
                        <li>
                            ...
                            <div className="row">
                              <div className="col-lg-6">
                                ...
                                <ul className="sub-menu">
                                  ...
                                  <li>
                                    <Link href="/cars-list-2">
                                      Cars List v2
                                    </Link>
                                  </li>
                                  <li>
                                    <Link href="/cars-list-3">
                                      Cars List v3
                                    </Link>
                                  </li>
                                  <li>
                                    <Link href="/cars-list-4">
                                      Cars List v4
                                    </Link>
                                  </li>
                                </ul>
