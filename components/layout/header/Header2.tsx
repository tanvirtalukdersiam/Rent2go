          ...
          <div className="container-fluid">
            <div className="text-header-info">
              ...
              <Link className="email-head text-white" href="/tel:123-456-7890">
                ...
                <span className="d-none d-lg-inline-block">
                  business@rent2go.com
                </span>
              </Link>
            </div>
            <div className="text-header">
              <div className="text-unlock text-sm-medium text-white">
                More than <span className="text-primary">300+</span> special
          ...
          <div className="main-header">
            <div className="header-left">
              <div className="header-logo">
                <Link className="d-flex" href="/index-2">
                  {/* <img
                  ...
                  >
                    <img
                      ...
                      src="/assets/imgs/app/app-1/steering-wheel.png"
                    />
                    <span
              ...
              <div className="header-nav">
                <nav className="nav-main-menu">
                  <ul className="main-menu">
                    <li className="">
                      <Link className="neutral-1000" href="/index-2">
                        Home
                      </Link>
                    ...
                    <li className=" ">
                      <Link className="neutral-1000" href="/cars-list-1">
                        Vehicles
                      </Link>
                    ...
                    <li className="">
                      <Link className="neutral-1000" href="/dealer-listing">
                        Dealers
                      </Link>
                    </li>
                    <li className="">
                      <Link className="neutral-1000" href="/shop-list">
                        Shop
                      </Link>
                      {/* <ul className="sub-menu">
                        <li>
                    ...
                    <li className="">
                      <Link className="neutral-1000" href="/about-us">
                        About Us
                      </Link>
                      {/* <ul className="sub-menu">
                        <li>
                    ...
                    <li className="">
                      <Link className="neutral-1000" href="/services">
                        Our Services
                      </Link>
                      {/* <div className="mega-menu">
                    ...
                    <li>
                      <Link className="neutral-1000" href="/contact">
                        Contact
                      </Link>
                    </li>
                  </ul>
